      ...
      <div className="flex border-b border-gray-700 mb-4">
        ...
        >
          ...
          {currentIntake?.refined_content && (
            <span className="ml-2 text-green-400 text-xs">(Available)</span>
          )}
        </button>
      </div>
        ...
        {activeSubTab === 'raw' ? (
          <>
            <textarea
              ...
              className="flex-1 w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none font-mono text-sm min-h-[200px]"
            />
          ...
          <>
            {currentIntake?.refined_content ? (
              <div className="flex-1 overflow-y-auto">
                <pre className="whitespace-pre-wrap text-sm text-gray-200 bg-gray-800 rounded-lg p-4 font-mono">
                  {currentIntake.refined_content}
                </pre>
              </div>
            ) : (
